...
export class SignInComponent implements OnInit {
  ...
  submitForm() {
    ...
    localStorage.setItem('userName', 'FarrukhRehman');
    localStorage.setItem('userToken', '1112sdfsfsdfsdfsdfsdfsdf');
    localStorage.setItem('type', 'A');
    location.href = document.getElementsByTagName('base')[0].href + 'app/admin';
